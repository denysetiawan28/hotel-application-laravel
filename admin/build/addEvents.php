  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">New Events</h1>
        </div>
...
<div class="well">
   ...
   <form id="tab" action="doAddEvents.php" method="post" enctype="multipart/form-data">
   		<label>Title</label>
        <input type="text" class="input-xlarge" name="title" placeholder="title">
        <label>File</label>
        <input type="file" name="filename"><br/><br/>
        <label>Description</label>
        <textarea rows="5" cols="50" class="input-xlarge" name="description" placeholder="description"></textarea><br/>
        <label>Date</label>
        <input type="date" class="input-medium" name="date">
        <label>Time</label>
        <input type="time" class="input-medium" name="time">
