    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Update User</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="users.php">Manage Users</a> <span class="divider">/</span></li>
...
<div class="well">
    ...
    <form id="tab" action="doUpdateUser.php" method="post">
        ...
        <label>DOB</label>
        <input type="date" class="input-xlarge" name="date" value="<?php echo $dob; ?>">
        <label>Email</label>
