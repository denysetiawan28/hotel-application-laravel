        ...
        <script type="text/javascript" charset="utf-8">
            $(document).ready(function(){
				...
				$(document).on('click','.remove',function() {
					...
					$('.btn-delete').attr({href: 'doDeleteTax.php?idTax=' + id});
				});
            })
...
<div class="btn-toolbar">
    ...
    <a href="addTax.php"><button class="btn btn-primary"><i class="icon-plus"></i> New Tax</button></a>
  <div class="btn-group">
  </div>
</div>
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT * FROM tax WHERE Status='Active'");
        ...
        <tr>
          ...
          <td>
              <a href="updateTax.php?idTax=<?php echo $row['ID_Tax']; ?>"><i class="icon-pencil"></i></a>
