...
<div class="well">
   ...
   <form id="tab" action="doAddFAQ.php" method="post">
   		<label>Question</label>
        <textarea rows="5" cols="50" class="input-xlarge" name="question" placeholder="question"></textarea><br/><br/>
        <label>Answer</label>
        <textarea rows="5" cols="50" class="input-xlarge" name="answer" placeholder="answer"></textarea><br/><br/>
