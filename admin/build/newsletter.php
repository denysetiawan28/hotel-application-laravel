...
<div class="btn-toolbar">
    <a href="confirmNewsletter.php"><button class="btn"><i class="icon-dashboard"></i> View Confirm Newsletter</button></a>
    <a href="rejectNewsletter.php"><button style="margin-left:20px;" class="btn"><i class="icon-dashboard"></i> View Reject Newsletter</button></a>
  <div class="btn-group">
  </div>
</div>
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT * FROM newsletter WHERE Status='Pending'");
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>Are you sure you want to delete the newsletter?</p>
    </div>
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
