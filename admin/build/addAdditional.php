  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">New Additional</h1>
        </div>
            ...
            <li class="active">New Additional</li>
        </ul>
...
<div class="well">
   ...
   <form id="tab" action="doAddAdditional.php" method="post">
   		<label>Additional Name</label>
        <input type="text" class="input-xlarge" name="name" placeholder="additional name">
        <label>Price</label>
        <input type="text" class="input-xlarge" name="price" placeholder="example : 100000">
        <label>Description</label>
        <textarea rows="5" cols="50" class="input-xlarge" name="description" placeholder="description"></textarea>
