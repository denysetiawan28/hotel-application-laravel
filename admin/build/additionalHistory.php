  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Additional History</h1>
        </div>
...
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT ad.ID_Additional_History, ad.ID_Additional, ad.Additional_Name, ad.Price, ad.Description, ad.Quantity, us.Name, ad.Action, ad.Created_Date FROM additional_history ad INNER JOIN user us ON ad.ID_User=us.ID_User");
			while($row = mysql_fetch_array($result)){
		?>
        <tr>
          <td><?php echo $row['ID_Additional_History']; ?></td>
