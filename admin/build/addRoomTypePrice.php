  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">New Room Type Price</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="#">Manage Charges</a></li> <span class="divider">/</span>
            <li><a href="roomTypePrice.php">Room Type Price</a> <span class="divider">/</span></li>
            <li class="active">New Room Type Price</li>
        </ul>
...
<div class="well">
   ...
   <form id="tab" action="doAddRoomTypePrice.php" method="post">
        ...
        <input type="date" class="input-medium" name="start">
        <label>End Date</label>
        <input type="date" class="input-medium" name="end">
        <label>Price</label>
        <input type="text" class="input-medium" name="price" placeholder="ex:100000">
