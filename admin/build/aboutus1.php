        ...
        <script type="text/javascript" charset="utf-8">
            $(document).ready(function(){
				...
				$(document).on('click','.remove',function() {
					...
					$('.btn-delete').attr({href: 'doDeleteAboutUs.php?idAboutUs=' + id});
				});
            })
...
<div class="btn-toolbar">
    <a href="addAboutus.php"><button class="btn btn-primary"><i class="icon-plus"></i> About Us</button></a>
  <div class="btn-group">
  </div>
</div>
<div>
