        ...
        <script type="text/javascript" charset="utf-8">
            $(document).ready(function(){
				...
				$(document).on('click','.confirm',function() {
					...
					$('.btn-delete').attr({href: 'doConfirmFeedback.php?idFeedback=' + id});
				});
				$(document).on('click','.remove',function() {
					var id = $(this).parents('tr').find('td:eq(0)').text();
					$('.btn-delete').attr({href: 'doRejectFeedback.php?idFeedback=' + id});
				});
            })
...
<div class="btn-toolbar">
    <a href="confirmFeedback.php"><button class="btn"><i class="icon-dashboard"></i> View Confirm Feedback</button></a>
    <a href="rejectFeedback.php"><button style="margin-left:20px;" class="btn"><i class="icon-dashboard"></i> View Reject Feedback</button></a>
  <div class="btn-group">
  </div>
</div>
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT * FROM feedback WHERE Status='Pending'");
