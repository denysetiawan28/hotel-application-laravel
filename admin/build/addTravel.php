  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">New Travel</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="travel.php">Manage Travel</a> <span class="divider">/</span></li>
            <li class="active">New Travel</li>
        </ul>
...
<div class="well">
   ...
   <form id="tab" action="doAddTravel.php" method="post" enctype="multipart/form-data">
   		<label>Travel Name</label>
        <input type="text" class="input-xlarge" name="name" placeholder="travel name">
        <label>Logo</label>
        <input type="file" name="logo"><br/><br/>
        <label>Travel Address</label>
        <textarea rows="4" cols="50" class="input-xlarge" name="address" placeholder="travel address"></textarea>
        <label>Travel Telp</label>
        <input type="text" class="input-xlarge" name="telp" placeholder="example : 021464646">
        <label>Travel Email</label>
        <input type="text" class="input-xlarge" name="email" placeholder="example : asdasd@yahoo.com">
        <label>Diskon (%)</label>
        <input type="text" class="input-medium" name="diskon" placeholder="example : 10">
