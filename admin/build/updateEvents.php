...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
	  ...
	  ?>
   <form id="tab" action="doUpdateEvents.php" method="post" >
   		<input type="hidden" name="id" value="<?php echo $id; ?>">
        <input type="hidden" name="file" value="<?php echo $file; ?>">
   		<label>Title</label>
        <input type="text" class="input-xlarge" name="title" value="<?php echo $title; ?>">
       	<label>Description</label>
        <textarea rows="5" cols="50" class="input-xlarge" name="description"><?php echo $description ?></textarea><br/>
        <label>Date</label>
        <input type="date" class="input-medium" name="date" value="<?php echo $date ?>">
        <label>Time</label>
        <input type="time" class="input-medium" name="time" value="<?php echo $time; ?>">
