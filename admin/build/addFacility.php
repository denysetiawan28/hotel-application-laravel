  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">New Facility</h1>
        </div>
...
<div class="well">
   ...
   <form id="tab" action="doAddFacility.php" method="post" enctype="multipart/form-data">
   		<label>Name</label>
        <input type="text" class="input-xlarge" name="name" placeholder="name">
        <label>Picture</label>
        <input type="file" name="picture"><br/><br/>
        <label>Description</label>
        <textarea rows="4" cols="50" class="input-xlarge" name="description" placeholder="description"></textarea>
