...
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT eh.ID_Events_History, eh.ID_Events, eh.Title, eh.File, eh.Description, eh.Date, eh.Time, us.Name, eh.Action, eh.Created_Date FROM events_history eh INNER JOIN user us ON eh.ID_User=us.ID_User");
			while($row = mysql_fetch_array($result)){
		?>
        <tr>
          <td><?php echo $row['ID_Events_History']; ?></td>
          <td><?php echo $row['ID_Events']; ?></td>
          <td><?php echo $row['Title']; ?></td>
          <td><a href="../../../public/resources/images/hotel/events/<?php echo $row['File']; ?>", target="_blank"><img src="../../../public/resources/images/hotel/events/<?php echo $row['File']; ?>" width="100px" height="100px"></a></td>
