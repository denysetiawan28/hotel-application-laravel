...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
	  ...
	  ?>
   <form id="tab" action="doUpdateTax.php" method="post">
   		<input type="hidden" name="id" value="<?php echo $id; ?>">
   		<label>Name</label>
        <input type="text" class="input-large" name="name" value="<?php echo $name; ?>">
        <label>Tax (%)</label>
        <input type="text" class="input-mini" name="tax" value="<?php echo $tax*100; ?>">
        <br/><br/>
