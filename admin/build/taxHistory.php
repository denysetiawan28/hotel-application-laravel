  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Tax History</h1>
        </div>
...
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT tx.ID_Tax_History, tx.ID_Tax, tx.Tax_Name, tx.Tax, us.Name, tx.Action, tx.Created_Date FROM tax_history tx INNER JOIN user us ON tx.ID_User=us.ID_User");
			while($row = mysql_fetch_array($result)){
		?>
        <tr>
          <td><?php echo $row['ID_Tax_History']; ?></td>
          <td><?php echo $row['ID_Tax']; ?></td>
