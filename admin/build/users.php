        ...
        <script type="text/javascript" charset="utf-8">
            $(document).ready(function(){
				...
				$(document).on('click','.removeUser',function() {
					...
					$('.btn-delete').attr({href: 'doNonActiveUser.php?idUser=' + id});
				});
            })
...
<div class="btn-toolbar">
    <a href="addUser.php"><button class="btn btn-primary"><i class="icon-plus"></i> New User</button></a>
  <div class="btn-group">
  </div>
</div>
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT * FROM user WHERE Status='Active'");
        ...
        <tr>
          ...
          <td>
              <a href="updateUser.php?idUser=<?php echo $row['ID_User']; ?>"><i class="icon-pencil"></i></a>
              <a href="#myModal" class="removeUser" role="button" data-toggle="modal"><i style="margin-left:20px;" class="icon-remove"></i></a>
          </td>
        </tr>
        <?php
			}
