  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Update Offer</h1>
        </div>
...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
	  ...
	  ?>
      	...
      	<form id="tab" action="doUpdateOffer.php" method="post" enctype="multipart/form-data">
        <div id="content">
          <div class="left">
          	<input type="hidden" name="idOffer" value="<?php echo $id; ?>">
            <input type="hidden" name="filename" value="<?php echo $file; ?>">
          	<label>Title</label>
            <input type="text" class="input-xlarge" name="titles" placeholder="title" value="<?php echo $title; ?>"><br/><br/>
            <label>Description</label>
            <textarea rows="5" cols="50" class="input-xlarge" name="description" placeholder="description"><?php echo $description; ?></textarea><br/><br/>
            <label>From Date</label>
            <input type="date" class="input-large" name="from" value="<?php echo $from; ?>"><br/><br/>
            <label>Until Date</label>
            <input type="date" class="input-large" name="until" value="<?php echo $until; ?>">
          </div>
          ...
          <div class="right1">
            ...
            <?php
				$result2 = mysql_query("SELECT do.ID_RoomType, rt.RoomType_Name, do.Promo FROM detail_offer do JOIN roomtype rt ON do.ID_RoomType=rt.ID_RoomType where ID_Offer='".$id."'");
				
			?>
            <select class="input-xlarge" id="roomDetail" name="roomDetail[]" multiple="yes" size="10">
            	<?php
					while($row2 = mysql_fetch_array($result2))
					{
						...
						$price = $row2[2];
				?>
                		<option value="<?php echo $idroom.'-'.$name.'-'.$price ?>" selected><?php echo $idroom.'-'.$name.'-'.$price ?></option><br/>
                <?php
