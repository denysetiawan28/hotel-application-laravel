...
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT nh.ID_News_History, nh.ID_News, nh.Title, nh.File, nh.Description, us.Name, nh.Action, nh.Created_Date FROM news_history nh INNER JOIN user us ON nh.ID_User=us.ID_User");
			while($row = mysql_fetch_array($result)){
		?>
        <tr>
          <td><?php echo $row['ID_News_History']; ?></td>
          <td><?php echo $row['ID_News']; ?></td>
          <td><?php echo $row['Title']; ?></td>
          <td><a href="../../../public/resources/images/hotel/news/<?php echo $row['File']; ?>", target="_blank"><img src="../../../public/resources/images/hotel/news/<?php echo $row['File']; ?>" width="100px" height="100px"></a></td>
