  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">New Tax</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="#.php">Manage Charges</a> <span class="divider">/</span></li>
            <li><a href="tax.php">Tax</a> <span class="divider">/</span></li>
...
<div class="well">
   ...
   <form id="tab" action="doAddTax.php" method="post">
   		<label>Tax Name</label>
        <input type="text" class="input-large" name="name" placeholder="tax name">
        <label>Tax (%)</label>
        <input type="text" class="input-medium" name="tax" placeholder="example :10">
        <br/><br/>
        ...
        <div>
            ...
            <a href="tax.php" class="btn btn-primary">Cancel</a>
        </div>
    </form>
      </div>
