  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Update Room Type</h1>
        </div>
...
<div class="well">
   ...
   <div id="content">
   	<div class="left">
    	<form id="tab" action="doUpdateRoomType.php" method="post">
    		<input type="hidden" name="id" value="<?php echo $id; ?>">
            <label>Name</label>
            <input type="text" class="input-xlarge" name="name" value="<?php echo $name; ?>">
            <label>Price</label>
            <input type="text" class="input-xlarge" name="price" value="<?php echo $price; ?>">
            <label>Capacity</label>
            <input type="text" class="input-xlarge" name="capacity" value="<?php echo $capacity; ?>">
            <label>Description</label>
            <textarea rows="7" cols="50" class="input-xlarge" name="description"><?php echo $description; ?></textarea>
            <label>Facility</label>
            <textarea rows="7" cols="50" class="input-xlarge" name="facility"><?php echo $facility; ?></textarea>
    ...
    <div class="right">
    	<?php
			$pic = mysql_query("SELECT * FROM roomtype_pic WHERE ID_RoomType = '".$id."' AND Main_Pic !='Delete'");
			while ($row = mysql_fetch_array($pic))
			{
		?>
				<div class="well">
                	<form action="doRoomTypeMainPicture.php" method="post">
                    <input type="hidden" name="idPic" value="<?php echo $row['ID_RoomType_Pic']; ?>"/>
                    <input type="hidden" name="idRoom" value="<?php echo $row['ID_RoomType']; ?>"/>
                    <table border=0 cellpadding="5px">
						<tr>
							<td colspan="2"><img src="<?php echo $pathRoom.$row['Picture']; ?>" width="270px" height="270px"></td>
						</tr>
						<tr>
							<?php
								if($row['Main_Pic']=="YES")
							...
							?>
                            <td align="right"><a href="doDeletePictureRoomType.php?idPic=<?php echo $row['ID_RoomType_Pic']; ?>&idRoom=<?php echo $row['ID_RoomType']; ?>"><i class="icon-remove"></i> Delete</a></td>
						</tr>
					</table>
                    </form>
				</div>
    ...
    <div class="right1">
   	 	<div class="well">
        	<form action="doAddRoomTypePic.php" method="post" enctype="multipart/form-data">
    		<input type="hidden" name="id" value="<?php echo $id; ?>">
