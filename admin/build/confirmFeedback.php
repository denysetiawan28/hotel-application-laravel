  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">View Confirm Feedback</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="feedback.php">Feedback</a> <span class="divider">/</span></li>
            <li class="active">Vew Confirm Feedback</li>
        </ul>
...
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT * FROM feedback WHERE Status='Confirm'");
