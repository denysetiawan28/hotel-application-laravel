        ...
        <script type="text/javascript" charset="utf-8">
            $(document).ready(function(){
				...
				$(document).on('click','.remove',function() {
					...
					$('.btn-delete').attr({href: 'doDeleteFAQ.php?idFAQ=' + id});
				});
            })
...
<div class="btn-toolbar">
    <a href="addFAQ.php"><button class="btn btn-primary"><i class="icon-plus"></i> New FAQ</button></a>
  <div class="btn-group">
  </div>
</div>
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT * FROM faq WHERE Status='Active'");
        ...
        <tr>
          ...
          <td>
              <a href="updateFAQ.php?idFAQ=<?php echo $row['ID_FAQ']; ?>"><i class="icon-pencil"></i></a>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>Are you sure you want to delete the faq?</p>
    </div>
