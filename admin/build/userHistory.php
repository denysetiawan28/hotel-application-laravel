...
<div>
    <table id="datatables" class="display">
      ...
      <tbody>
      	<?php
			$result = mysql_query("SELECT uh.ID_User_History, uh.ID_User, uh.Role, uh.Username, uh.Name, uh.DOB, uh.Email, us.Name, uh.Action, uh.Created_Date FROM user_history uh INNER JOIN user us ON uh.ID_Login=us.ID_User");
			while($row = mysql_fetch_array($result)){
		?>
        <tr>
          <td><?php echo $row['ID_User_History']; ?></td>
