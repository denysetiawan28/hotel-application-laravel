        ...
        <div class="blog ">
            <div class="row section-color">
                ...
                <aside class="col-md-4">
                    ...
                    <div class="widget blog-item div-sidebar">
                        <h3 class="header-sidebar">Travel Industry</h3>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            {{Form::open(array("url"=>URL::action('login-travel'),"method"=>"post"))}}
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    {{ Form::label("travel","Travel ID :") }}
                                    {{ Form::text("travelid",null,array('class'=>'form-control')) }}
                                    @if($errors->travel)
                                    {{ $errors->travel->first('travelid','<div class="error">*:message.</div>')}}
                                    @endif
                                </div>
