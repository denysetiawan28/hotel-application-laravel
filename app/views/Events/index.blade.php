...
@section("title")Events - Everyday Smart Hotel @stop
@section("content")

<section id="blog" class="container">
        <div class="center">
            <h2><a href="{{URL::to('/')}}">Home </a> <i class="fa fa-caret-right"></i> Events </h2>
        </div>
                    ...
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-10 blog-content">
                                <h2><a href="{{ URL::to('/events/view/'. $item->ID_Events) }}">{{ $item->Title }}</a></h2>
                                <a href="#"><img class="img-responsive img-blog" src="{{ URL::to('/') }}/resources/images/hotel/events/{{ $item->File }}" width="100%" alt="" /></a>
                                <h3>{{ $item->IsiEvents }}</h3>
                                <a class="btn btn-primary readmore" href="{{ URL::to('/events/view/'. $item->ID_Events) }}">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
