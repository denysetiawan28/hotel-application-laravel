...
<section id="blog" class="container">
        <div class="center">
            <h2><a href="{{URL::to('/')}}">Home</a> <i class="fa fa-caret-right"></i> <a href="{{URL::to('/events')}}">Events</a> <i class="fa fa-caret-right"></i> </h2>
        </div>
                            ...
                            <div class="col-xs-12 col-sm-2 text-center">
                                <div class="entry-meta">
                                    <span id="publish_date">
                                        <p>Created Date</p>
                                        <p>{{$events->Date}}</p></span>
                                </div>
                            </div>

                            <div class="col-xs-12 col-sm-10 blog-content">
                                <h2><a href="{{ URL::to('/events/view/'. $events->ID_Events) }}">{{ $events->Title }}</a></h2>
                                <a href="#"><img class="img-responsive img-blog" src="{{ URL::to('/') }}/resources/images/hotel/events/{{ $events->File }}" width="100%" alt="" /></a>
