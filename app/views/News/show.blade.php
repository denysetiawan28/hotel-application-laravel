...
<section id="blog" class="container">
    <div class="center">
        <h2><a href="{{URL::to('/')}}">Home</a> <i class="fa fa-caret-right"></i> <a href="{{URL::to('/news')}}">News</a> <i class="fa fa-caret-right"></i> </h2>
    </div>
             ...
             <div class="col-md-8 div-main">
                <div class="blog-item">
                    <div class="row">
                        ...
                        <h2><a href="{{ URL::to('/news/view/'. $news->ID_News) }}">{{ $news->Title }}</a></h2>
                            <a href="#"><img class="img-responsive img-blog" src="{{ URL::to('/') }}/resources/images/hotel/news/{{ $news->File }}" width="100%" alt="" /></a>
